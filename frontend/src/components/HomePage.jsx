  ...
  const features = [
    {
      ...
      action: () => navigate('registration', { relative: 'path' }),
      color: 'green'
    },
    {
      icon: Trophy,
      ...
      action: () => navigate('tournament', { relative: 'path' }),
      color: 'purple'
    },
    {
      icon: Play,
      ...
      action: () => navigate('live', { relative: 'path' }),
      color: 'orange'
    }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button 
                onClick={() => navigate('registration', { relative: 'path' })}
              ...
              <button 
                onClick={() => navigate('live', { relative: 'path' })}
      ...
      <section className="bg-gradient-to-r from-green-600 to-purple-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button 
                onClick={() => navigate('tournament', { relative: 'path' })}
